...
Tras descargar y extraer este proyecto, necesita ejecutar los siguientes comandos en la carpeta donde lo extrajo:
...
1. Crea una copia de `plantilla_generica.yaml`
...
4. Guárdalo con un nombre descriptivo como: `reglas_vibrafono.yaml`, `reglas_cuarteto.yaml`, etc.
5. Cárgalo en la app con el botón **Cargar**
